    ...
    <div className="termsAndConContainer">
      ...
      <div className="termsAndCon1">
        <div className="termsAndCon2">
          ...
          <p>Last updated: September 28, 2022</p>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Levin.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Levin, accessible from{" "}
                <a
                  href="www.levin.com"
          ...
          <ul>
            <li>By email: levin@gmail.com</li>
          </ul>
        </div>
      </div>
    </div>
